...
2. <a href="#2">How it works</a>
   + <a href="#2.1">Installation</a>
   + <a href="#2.2">Usage</a>
   + <a href="#2.3">Demo video</a>
3. <a href="#3">Technology and Method</a>
   + <a href="#3.1">Components we used</a>
   + <a href="#3.2">Softwares used and Development environment</a>
4. <a href="#4">Developers</a>  
...
## <a id="2"></a> How it works.

#### <a id="2.1"></a> Installation
The user will be able to install this by downloading the zip file from our GitHub repository.https://github.com/DIT112-V20/group-11
After downloading it, the user open their Android Studio app and upload the Trailgage app to their android phone. The user should now be able to access the car using the app.
...
There is also an information page which briefly explains the purpose of the app in case the user would like to know more about it.

<img src="https://github.com/DIT112-V20/group-11/blob/master/assets/SS1.png" width="150">  <img src="https://github.com/DIT112-V20/group-11/blob/master/assets/SS5.png" width="150">  <img src="https://github.com/DIT112-V20/group-11/blob/master/assets/SS3.png" width="150">  <img src="https://github.com/DIT112-V20/group-11/blob/master/assets/SS%202.png" width="150">  <img src="https://github.com/DIT112-V20/group-11/blob/master/assets/SS4.png" width="150">

#### <a id="2.3"></a> Demo Video
Here is the link to a quick demonstration video of how it works.
<div align="center">
      <a href="https://meet.google.com/linkredirect?authuser=0&dest=https%3A%2F%2Fyoutu.be%2FxZhSSO3LWiM">
     <img 
      src="https://img.youtube.com/vi/xZhSSO3LWiM/0.jpg" 
...
## <a id="3"></a>Technology and Method

### <a id="3.1"></a>Components we used
How we made it?
...
### <a id="3.2"></a>Softwares used and Development environment
